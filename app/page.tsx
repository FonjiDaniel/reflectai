          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div id="contact"> {/* Keep ID if needed for internal links */}
              ...
              <ul className="space-y-2 text-sm">
                ...
                {/* Avoid displaying phone numbers directly if possible for spam reasons, or use a contact form */}
                {/* <li className="text-gray-400">1-800-REFLECT</li> */}
              </ul>
              {/* Social Links */}
              <div className="flex space-x-4 mt-4">
                ...
                {/* <a href="h" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="Instagram">
